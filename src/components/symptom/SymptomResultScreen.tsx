    ...
    <div className="flex h-svh w-full justify-center overflow-hidden bg-[#F3F4F6]">
      <div className="flex h-svh w-full max-w-[402px] flex-col bg-white">
        ...
        <div className="flex flex-1 flex-col overflow-y-auto px-[20px] py-[24px] gap-[28px]">
          ...
          {/* AI 분석 완료 카드 */}
          <div className="rounded-[10px] bg-[#c0ffe4] px-[24px] py-[24px]">
            <div className="mb-[12px] flex items-center gap-[10px]">
              <p className="text-left text-[24px] font-bold tracking-[-1.2px] text-[#111827]">AI 분석 완료</p>
          ...
          {/* 선택된 증상 */}
          <div>
            <p className="mb-[16px] text-left text-[18px] font-medium tracking-[-0.9px] text-black">선택된 증상</p>
          ...
          {/* AI 추천 진료과 */}
          <div>
            <p className="mb-[16px] text-left text-[18px] font-medium tracking-[-0.9px] text-black">AI 추천 진료과</p>

            {/* 내과 - 주요 */}
            <div className="relative rounded-[10px] bg-[rgba(41,109,255,0.1)] px-[24px] py-[24px]">
              <div className="absolute right-[16px] top-[16px] flex h-[35px] items-center rounded-[20px] bg-white px-[15px]">
                <span className="text-[14px] font-medium tracking-[-0.7px] text-[#111827]">85%</span>
              </div>
              <p className="text-left text-[24px] font-bold tracking-[-1.2px] text-[#111827]">내과</p>
              <div className="mt-[10px] mb-[14px] inline-flex h-[30px] items-center rounded-[10px] bg-[#296dff] px-[15px]">
              ...
              <p className="mt-[8px] text-left text-[14px] font-medium tracking-[-0.7px] text-[#6b7280]">
          ...
          {/* 대안 진료과 */}
          <div>
            <p className="mb-[16px] text-left text-[18px] font-medium tracking-[-0.9px] text-black">대안 진료과</p>
            <div className="relative rounded-[10px] border border-[#d1d5db] bg-white px-[24px] py-[24px]">
              <div className="absolute right-[16px] top-[16px] flex h-[35px] items-center rounded-[20px] bg-[#f3f4f6] px-[15px]">
                <span className="text-[14px] font-medium tracking-[-0.7px] text-[#111827]">60%</span>
              </div>
              <p className="text-left text-[18px] font-bold tracking-[-0.9px] text-[#111827]">신경과</p>
              <p className="mt-[12px] text-left text-[16px] font-medium leading-[1.5] tracking-[-0.8px] text-[#6b7280]">
          ...
          {/* 주의사항 */}
          <div className="rounded-[10px] bg-[#fff6db] px-[24px] py-[24px]">
            <p className="mb-[14px] text-left text-[18px] font-bold tracking-[-0.9px] text-[#111827]">주의사항</p>
            <p className="mb-[20px] text-left text-[16px] font-medium leading-[1.5] tracking-[-0.8px] text-[#6b7280]">
              해당 안내는 증상 기반의 진료과 추천 정보이며, 의료적 진단이나 치료를 대체하지 않습니다.
            </p>
            <label
            ...
            >
              ...
              <span className="text-left text-[16px] font-medium tracking-[-0.8px] text-[#6b7280]">
                네, 주의 사항을 확인했습니다.
              </span>
            </label>
          </div>
